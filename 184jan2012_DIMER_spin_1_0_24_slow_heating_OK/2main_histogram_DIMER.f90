...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%!            
      ...
      INTEGER (KIND=4) :: natx,naty,natz,n_atom,n_EN_histo,n_Ti_histo,i_histo,i_Ti_histo
      REAL    (KIND=8) :: delT_histo,P_config

      REAL    (KIND=8) :: To,T,Z_histo,EN_moy_histo,Mz_moy_histo
      ...
      REAL    (KIND=8),DIMENSION(:),ALLOCATABLE :: EN_histo,Mz_histo,P_histo,Po_histo
...
!!!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      DO i_histo=1,n_EN_histo
            READ(12,*)To,EN_histo(i_histo),Mz_histo(i_histo),EN_2_histo(i_histo),Mz_2_histo(i_histo),&
                      Mz_EN_histo(i_histo),Mz_2_EN_histo(i_histo),Po_histo(i_histo)
      END DO 
...
!!!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      DO i_histo=1,n_EN_histo
            Z_histo=Z_histo+Po_histo(i_histo)*exp(real(n_atom)*((1./To-1./T)*EN_histo(i_histo)))
      END DO


      DO i_histo=1,n_EN_histo

            P_histo(i_histo)=Po_histo(i_histo)*exp(real(n_atom)*((1./To-1./T)*EN_histo(i_histo)))/Z_histo
...
!!! Tinh gia tri trung binh tai diem To va lan can no
      DO i_histo=1,n_EN_histo
            EN_moy_histo=EN_moy_histo+EN_histo(i_histo)*P_histo(i_histo)
      ...
      Cv_histo=real(natx*naty*natz*0.3)*(EN_2_moy_histo-EN_moy_histo**2.)/(T**2.)
      Ksi_histo=real(natx*naty*natz*0.3)*(Mz_2_moy_histo-Mz_moy_histo**2.)/T
      V1_histo=EN_moy_histo-(Mz_EN_moy_histo/Mz_moy_histo)
      V2_histo=EN_moy_histo-(Mz_2_EN_moy_histo/Mz_2_moy_histo)
      
      WRITE(Ligne31,*)T,EN_moy_histo,Mz_moy_histo,Cv_histo,Ksi_histo,V1_histo,V2_histo
